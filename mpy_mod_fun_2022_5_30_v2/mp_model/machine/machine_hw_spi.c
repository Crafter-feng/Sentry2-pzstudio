...
MP_STATIC const machine_hw_spi_default_pins_t machine_hw_spi_default_pins[2] = {
...
MP_STATIC machine_hw_spi_obj_t machine_hw_spi_obj[2];

MP_STATIC void machine_hw_spi_deinit_internal(machine_hw_spi_obj_t *self) {
...
MP_STATIC void machine_hw_spi_init_internal(
...
MP_STATIC void machine_hw_spi_deinit(mp_obj_base_t *self_in) {
...
MP_STATIC mp_uint_t gcd(mp_uint_t x, mp_uint_t y) {
    while (x != y) {
        if (x > y) {
            x -= y;
        } else {
...
MP_STATIC void machine_hw_spi_transfer(mp_obj_base_t *self_in, size_t len, const uint8_t *src, uint8_t *dest) {
...
MP_STATIC void machine_hw_spi_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind) {
    machine_hw_spi_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
MP_STATIC void machine_hw_spi_init(mp_obj_base_t *self_in, size_t n_args, const mp_obj_t *pos_args, mp_map_t *kw_args) {
    machine_hw_spi_obj_t *self = (machine_hw_spi_obj_t *)self_in;
...
MP_STATIC const mp_machine_spi_p_t machine_hw_spi_p = {
